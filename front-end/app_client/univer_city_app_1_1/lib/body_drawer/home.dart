        ...
        if(fav.isEmpty){
          ...
          return ListView.builder(
            itemBuilder: (context, i){
              ...
              if(i==fav.length+1)return SizedBox(height: 72,);
              return Dismissible(
                  key: Key(fav[i-1]),
                  ...
                  secondaryBackground: Container(color: Theme.of(context).accentColor,child: Center(child: Padding(padding: EdgeInsets.symmetric(horizontal: 18), child: Row(mainAxisAlignment: MainAxisAlignment.end,children: <Widget>[Icon(Icons.delete)])))),
